...
import { SubscriptionTier, BillingCycle, SubscriptionStatus } from '../../domain/entities/Subscription';
    ...
    components: {
      schemas: {
          ...
          properties: {
            ...
            error: {
              ...
              properties: {
                code: {
                  type: 'string',
                  enum: ['VALIDATION_ERROR', 'QUOTA_EXCEEDED', 'SUBSCRIPTION_REQUIRED', 'PAYMENT_FAILED', 'RESOURCE_NOT_FOUND', 'INTERNAL_ERROR'],
        ...
        CreateSubscriptionRequest: {
          ...
          properties: {
            ...
            tier: {
              ...
              example: 'BASIC',
              description: 'Subscription tier: BASIC (10 messages), PRO (100 messages), ENTERPRISE (unlimited)'
            },
            billingCycle: {
              type: 'string',
        ...
        SubscriptionResponse: {
          ...
          required: ['id', 'tier', 'billingCycle', 'maxMessages', 'messagesUsed', 'price', 'startDate', 'endDate', 'autoRenew', 'status', 'remainingQuota']
        },
