  ...
  private getChatMessageSeedData(): ChatMessageSeedData[] {
    ...
    const sampleQA = [
      ...
      },
      {
        ...
        answer:
          'Machine learning is a subset of AI that enables computers to learn and improve from experience without being explicitly programmed. It works by using algorithms to analyze data, identify patterns, and make predictions or decisions. The process involves training a model on a dataset, validating its performance, and then using it to make predictions on new, unseen data.',
        tokens: 92,
      },
      {
      ...
      },
      {
        ...
        answer:
          "SQL databases are relational databases that use structured query language (SQL) for defining and manipulating data. They have a predefined schema and support ACID transactions. NoSQL databases are non-relational and can handle unstructured data with flexible schemas. They're designed for scalability and can be document-based, key-value, column-family, or graph databases.",
        tokens: 96,
      },
      {
        question: 'How do I improve my coding skills?',
        answer:
          "To improve coding skills: 1) Practice regularly with coding challenges, 2) Read and contribute to open-source projects, 3) Learn new programming languages and frameworks, 4) Build personal projects, 5) Code review others' work, 6) Stay updated with industry trends, 7) Join coding communities, and 8) Focus on understanding algorithms and data structures.",
        tokens: 89,
      },
      {
        question: 'What is DevOps?',
        answer:
          'DevOps is a set of practices that combines software development (Dev) and IT operations (Ops) to shorten the development lifecycle and provide continuous delivery with high software quality. It emphasizes collaboration, automation, monitoring, and communication between development and operations teams throughout the entire software development process.',
        tokens: 71,
      },
      {
        question: 'Explain microservices architecture',
        answer:
          'Microservices architecture is an approach to building applications as a collection of small, independent services that communicate over well-defined APIs. Each service is responsible for a specific business function, can be developed and deployed independently, and typically uses different technologies. This approach offers benefits like scalability, flexibility, and fault isolation.',
        tokens: 87,
      },
    ];
